<div class="container mx-auto pb-4 px-4 sm:px-6 lg:px-8 grid grid-cols-12 gap-4">
    <div class="col-span-12 p-2 rounded-b-xl bg-base-100 shadow-xl shadow-gray-400">Hi</div>
    <div class="col-span-12 lg:col-span-9 rounded-xl shadow-xl shadow-gray-400">
    ...
    <div class="grid grid-cols-12 gap-4 col-span-12 lg:col-span-9 bg-base-100 rounded-xl p-2 shadow-xl shadow-gray-400">
        <div class="border-b border-gray-200 col-span-12">
            <div role="tablist" class="tabs tabs-lifted grid-cols-12" x-data="{
                ...
                <span role="tab" class="tab text-xs col-span-3 bg-base-200" @click="setTab(0)"
                    x-bind:class="[ (activeTab === 0 )?'tab-active':'' ] ">
                    Resources
                </span>
                <span role="tab" class="tab text-xs col-span-3 bg-base-200" @click="setTab(1)"
                    x-bind:class="[ (activeTab === 1 )?'tab-active':'' ] ">
                    Civic Buildings
                </span>
                <span role="tab" class="tab text-xs col-span-3 bg-base-200" @click="setTab(2)"
                    x-bind:class="[ (activeTab === 2 )?'tab-active':'' ] ">
                    Military Buildings
                </span>
                <div class="tab cursor-default col-span-3">
                </div>

                <div role="tabpanel" class="bg-base-100 border-base-300 rounded-box p-6 col-span-12"
                    x-show="activeTab === 0" x-transition:enter="transition ease-out duration-300"
                    x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
                    <div class="grid grid-cols-6 gap-4">
                        {{-- <livewire:components.structure-card :structure="$outpost->lumberCamp()->toArray()" />
